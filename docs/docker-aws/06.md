...
![](assets/a199eec7-ad83-4e86-bd90-ac0febe0df2f.png)
...
您现在已经完成了所有定制，是时候使用`packer build`命令重建您的图像了。在您这样做之前，现在是验证您是否有正确的 Packer 模板，以及是否已经创建了相关的支持文件的好时机。以下示例显示了您现在应该在 packer-ecs 存储库中拥有的文件夹和文件结构:
...
![](assets/286a5d2f-7e98-467b-a671-5f3ad55eaf24.png)
...
![](assets/c0fd0ffb-bc0b-4026-b9c0-9d8232b143cd.png)
...
![](assets/99e70e6b-1183-437c-bf3b-7d2c04fde547.png)
