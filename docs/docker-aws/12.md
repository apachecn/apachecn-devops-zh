...
![](assets/f68b3eb6-74a7-4799-94d9-feaa134f7d59.png)
...
*   每个 ECS 容器实例目前都有 800 MB 的备用容量。使用前面讨论的可用容量计算，这相当于内存资源方面的八个 ECS 任务集群的当前可用容量，我们将其称为![](assets/d214eb41-2e71-45da-babb-68b187099957.png):
