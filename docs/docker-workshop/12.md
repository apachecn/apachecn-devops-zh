...
*第 3 章*、*管理你的码头工人映像*，也看到我们做了一些工作，使我们的映像尽可能小。我们看到，通过缩小映像的大小，可以更快地构建映像。然后，它们也可以被拉得更快，并在我们的系统上运行。安装在容器上的任何不必要的软件或应用都可能占用主机系统上的额外空间和资源，并可能因此降低我们的服务速度。
