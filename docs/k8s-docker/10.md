...
所有网络都应被视为“不可信的”假设所有网络都是敌对的，这将导致更安全的实现方法。这也意味着需要安全性的服务需要经过身份验证。这个概念叫做零信任。多年来，身份专家一直在使用和倡导这一技术，但谷歌的 BeyondCorp 白皮书([https://cloud.google.com/beyondcorp](https://cloud.google.com/beyondcorp))在 DevOps 和云原生世界中推广了这一技术。零信任的概念也应该适用于你的集群！
