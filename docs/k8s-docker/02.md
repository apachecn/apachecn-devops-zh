...
![Figure 2.1 – Docker folder directories  ](image/Fig_2.1_B15514.jpg)
...
![Table 2.1 – Volume management options ](image/B15514_Table_2.1.jpg)
...
![Figure 2.2 – Anonymous volume output ](image/Fig_2.2_B15514.jpg)
...
![Figure 2.3 – Named volume output ](image/Fig_2.3_B15514.jpg)
...
![Figure 2.4 – MySQL persistent volume ](image/Fig_2.4_B15514.jpg)
...
![Figure 2.5 – Locking error output ](image/Fig_2.5_B15514.jpg)
...
![Figure 2.6 – docker volume list output  ](image/Fig_2.6_B15514.jpg)
...
![Figure 2.7 – docker prune confirmation ](image/Fig_2.7_B15514.jpg)

图 2.7–码头工人清理确认

**选择** `y` **为是小心**–此动作没有撤销命令。执行后，您将收到已删除卷的摘要，包括它们的名称和回收的总磁盘空间:

![Figure 2.8 – docker prune results ](image/Fig_2.8_B15514.jpg)
...
![Table 2.2 – Docker tmpfs optiond ](image/B15514_Table_2.2.jpg)
...
![Figure 2.9 – Docker volume list ](image/Fig_2.9_B15514.jpg)
...
![Figure 2.10 – Docker inspect output ](image/Fig_2.10_B15514.jpg)

图 2.10–码头工人检查输出

当使用`docker exec`命令时，您也可以通过执行 Linux `df`命令来验证正在运行的容器内的装载:

![Figure 2.11 – tmpfs mount in Linux ](image/Fig_2.11_B15514.jpg)
