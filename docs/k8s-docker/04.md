...
![Table 4.1 – Kubernetes components and objects ](image/Table_4.1.jpg)
...
![Table 4.2 – Basic kubectl commands ](image/Table_4.2.jpg)
...
![Figure 4.1 – Host process list showing control plane components ](image/Fig_4.1_B15514.jpg)

图 4.1–显示控制平面组件的主机进程列表

如果你要进入一个工作节点检查组件，你会看到所有标准的工作节点组件:

![Figure 4.2 – Host process list showing worker components ](image/Fig_4.2_B15514.jpg)
...
![Figure 4.3 – kubectl get pods showing local-path-provisioner ](image/Fig_4.3_B15514.jpg)
...
如果你想知道基础映像是如何创建的细节，可以在[https://GitHub . com/kubernetes-sigs/KinD/blob/control plane/images/base/Dockerfile](https://github.com/kubernetes-sigs/kind/blob/controlplane/images/base/Dockerfile)上查看 KinD 团队 GitHub 资源库中的 docker file。
...
![Figure 4.4 – Host cannot communicate with KinD directly ](image/Fig_4.4_B15514.jpg)
...
![Figure 4.5 – Host communicates with KinD via an Ingress controller ](image/Fig_4.5_B15514.jpg)
...
![Table 4.3 – KinD configuration options ](image/Table_4.3.jpg)
...
![Table 4.4 – KinD configuration options ](image/Table_4.4.jpg)
...
![Figure 4.6 – KinD cluster creation output ](image/Fig_4.6_B15514.jpg)
...
![Figure 4.7 – Calico installation output ](image/Fig_4.7_B15514.jpg)
...
![Figure 4.8 – NGINX installation output ](image/Fig_4.8_B15514.jpg)
...
![Figure 4.9 – CSInode describe ](image/Fig_4.9_B15514.jpg)
...
![Figure 4.10 – Multiple driver example ](image/Fig_4.10_B15514.jpg)
...
![Figure 4.11 – Default storage class ](image/Fig_4.11_B15514.jpg)
...
![Figure 4.12 – PV and PVC example ](image/Fig_4.12_B15514.jpg)
...
![Figure 4.13 – Custom HAProxy container running ](image/Fig_4.13_B15514.jpg)
...
![Figure 4.14 – worker2 is in a NotReady state ](image/Fig_4.14_B15514.jpg)
