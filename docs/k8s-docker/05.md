...
![Figure 5.1 – Kubernetes cluster components ](image/Fig_5.1_B15514.jpg)
...
![Figure 5.2 – List of Kubernetes nodes ](image/Fig_5.2_B15514.jpg)
...
![Figure 5.5 – Verbosity description ](image/Fig_5.5_B15514.jpg)
...
在我们继续理解库本内特对象到底是什么之前，让我们首先解释库本内特对象的表现。
...
![Figure 5.6 – Kubernetes API resources ](image/Fig_5.6_B15514.jpg)
...
![Figure 5.7 – kubectl ConfigMap output ](image/Fig_5.7_B15514.jpg)
...
![Figure 5.8 – All Pods in the kube-system namespace ](image/Fig_5.8_B15514.jpg)
...
![Figure 5.9 – StatefulSet manifest example ](image/Fig_5.9_B15514.jpg)
