...
在本章中，我们将回顾几种公共云和私有云选项和技术及其可能的交集。我们最终将在[第 11 章](11.html "Chapter 11. What is next?")*中对待 **CaaS** ( **集装箱即服务**)和 **IaaC** ( **基础设施即代码**)的全新流行语，接下来是什么？*
...
![Docker for AWS](graphics/image_10_001.jpg)

然后，您可以指定一些基本和高级选项:

![Docker for AWS](graphics/image_10_002.jpg)
...
![Docker for AWS](graphics/image_10_003.jpg)
...
![Docker for AWS](graphics/image_10_004.jpg)
...
![Docker for Azure](graphics/image_10_005.jpg)

一切正常后，点击**确定****创建**即可。

![Docker for Azure](graphics/image_10_006.jpg)
...
![Docker for Azure](graphics/image_10_007.jpg)
...
*   **Murano:** 这是应用程序目录，可以从开源社区维护的目录中运行应用程序，包括 Docker 和 Kubernetes 容器。
*   **Magnum:** 这是 Rackspace 的集装箱即服务解决方案。
...
![OpenStack Magnum](graphics/image_10_008.jpg)
...
![Architecture and core concepts](graphics/image_10_009.jpg)
...
![Install HA Magnum on Mirantis OpenStack](graphics/image_10_010.jpg)
...
![Install HA Magnum on Mirantis OpenStack](graphics/image_10_011.jpg)
...
![Configure an HA Magnum installation](graphics/image_10_012.jpg)
