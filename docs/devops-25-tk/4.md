...
![](assets/fb08d36b-cba3-4acb-8385-f3836d1a1f1d.png)
...
![](assets/8052c5cf-a627-4785-a91b-28e759a53a1c.png)
...
该图向我们显示了请求持续时间的历史，但它并没有让我们更接近于揭示问题的原因，或者更准确地说，是应用程序中缓慢的部分。我们可以尝试使用其他指标，但它们或多或少都是通用的，可能不会让我们有所收获。我们需要更详细的特定于应用程序的指标。我们需要来自`go-demo-5`应用程序内部的数据。
...
![](assets/a36dd797-57ba-4cf7-bc6c-8da9161fd59c.png)
...
![](assets/17add48b-f7c5-4e29-90e6-43dcf3919682.png)
...
![](assets/e4efb795-db45-4d39-87be-b5982c518722.png)
...
![](assets/ab8b8a7e-6ecd-45ec-a77a-3dd0ffd7cfdd.png)
...
![](assets/f862b0b0-9ab7-4d89-93f9-4349c9692d69.png)
