...
![](Images/f63b2904-5c6a-44d2-a8ab-b8c16cbc2d7d.png)
...
![](Images/033eadfb-a669-42ea-adb8-ee1b7dd00bdf.png)
...
![](Images/1dd6011f-fe9c-43e5-aad4-3d00627cf26e.png)
...
![](Images/81d8277b-9f6f-41da-8882-0a5a4061dab4.png)
...
![](Images/81479591-d561-413e-9abe-d744fe3e71af.png)
...
![](Images/28f3d88f-f07c-4c7a-8b83-c97cc5a739b5.png)
...
![](Images/994969a3-833f-4080-902b-aa4b924c5ea9.png)

完成后，点击**部署容器**，几秒钟后，您将返回正在运行的容器列表，您应该会看到您新启动的容器:

![](Images/df751dbc-16d2-4f8b-8dc6-1abba5022868.png)

使用列表中每个容器左侧的勾号框将启用顶部的按钮，您可以在其中控制容器的状态-确保不要**杀死**或**移除**集装箱。点击容器的名称，在我们的例子中是**集群**，将显示更多关于容器本身的信息:

![](Images/cd68e95c-2580-4dfa-ac5e-41af1c5dcf3b.png)
...
![](Images/9e874f94-8dfd-4f46-82d4-b06e9f9ce701.png)
...
![](Images/85131733-5b8c-45a0-a519-70b57c460ec1.png)
...
![](Images/a1a2535d-fb95-4cca-badd-1c84c17f5c45.png)
...
![](Images/e2b3db1c-dcb7-4b2d-949b-84a7d2bdd4c1.png)
...
![](Images/0e6e4323-5fae-4de1-8c74-47c357492212.png)
...
![](Images/1f6b826a-dd7c-437a-bd0b-4e03e23c0e74.png)
...
![](Images/7322577c-78c1-4836-b290-5f95e5b3e4bd.png)
...
![](Images/53d7a673-1fe4-482c-9525-50f925aaf3c4.png)
...
![](Images/f73d75d1-6f79-4794-a20e-6bebdce83c3b.png)
...
![](Images/fd4d1e74-0ad4-4dbf-a2c3-5a34b91ee1bf.png)
...
![](Images/a13868d7-88bf-40ae-9c9c-b01ba405b27d.png)
...
点击 **+添加堆栈**按钮，然后将上面的内容粘贴到网页编辑器中，输入名称`MobyCounter`，不要在名称中添加任何空格或特殊字符，因为这是 Docker 使用的，然后点击**部署堆栈**。

部署后，您将能够点击**移动计数器**并管理堆栈:

![](Images/f6b6017d-3a92-44d3-8c19-2720e6115860.png)
...
![](Images/098c7993-08e7-4248-94de-46effda21158.png)
...
![](Images/a9e27419-518a-475d-ba8b-0e4204160578.png)

您可以动态地对**服务**进行许多更改，包括放置约束、重启策略、添加服务标签等等。页面底部是与服务相关的任务列表:

![](Images/e5341775-3d05-45d8-8f58-9cf92908c2fc.png)

如您所见，我们有六个正在运行的任务，三个节点各有两个。点击左侧菜单中的**容器**可能会显示与您预期不同的内容:

![](Images/d60f20dd-8806-4bfd-bc7a-fa44f6973644.png)
...
![](Images/e367b2ca-bca4-4833-82c5-22682805ecce.png)
