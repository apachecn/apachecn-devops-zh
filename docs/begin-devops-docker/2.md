...
![Installing docker-compose](graphics/image02_01.jpg)
...
![Using docker-compose](graphics/image02_02.jpg)
...
![docker-compose first run](graphics/image02_03.jpg)
...
2.  Create a new file and name it `docker-compose.yml.` Add the code in `wordpress-docker-compose.yml` or copy the following figure:
    ...
    ![Activity 1 — Running WordPress Using docker-compose](graphics/image02_04.jpg)
...
![Activity 1 — Running WordPress Using docker-compose](graphics/image02_05.jpg)
...
![Activity 1 — Running WordPress Using docker-compose](graphics/image02_06.jpg)
...
![The docker-compose file: docker-compose.yml](graphics/image02_07.jpg)
...
![Managing Multiple Containers and Distributed Application Bundles](graphics/image02_08.jpg)
...
![The Django Compose File Broken Down](graphics/image02_09.jpg)

该命令被翻译为以下内容:

![The Django Compose File Broken Down](graphics/image02_10.jpg)

打开终端中的另一个标签或窗口并运行`docker ps`。你会看到集装箱在运转。

另一方面，根据示例的`web`服务容器将在以下步骤中运行:

![The Django Compose File Broken Down](graphics/image02_11.jpg)
...
![The Django Compose File Broken Down](graphics/image02_12.jpg)
...
![Endure Data Using Volumes](graphics/image02_13.jpg)
...
![Endure Data Using Volumes](graphics/image02_14.jpg)

### 注

只要在`docker-compose`文件中定义了卷，当进行本地更改(如文件更新)时，更改将自动同步到容器中的文件。

![Endure Data Using Volumes](graphics/image02_15.jpg)
...
![Ports](graphics/image02_17.jpg)

以及`do‑cker-compose.yml`中的以下几行:

![Ports](graphics/image02_18.jpg)
...
![Networking with docker-compose](graphics/image02_20.jpg)
...
![Run the WordPress Containers](graphics/image02_23.jpg)
...
![Run the WordPress Containers](graphics/image02_24.jpg)
