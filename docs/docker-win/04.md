...
Docker Hub 可以在不进行身份验证的情况下使用，以拉取公共映像，但是要上传映像(或拉取私有映像)，您需要注册一个帐户。注册在[https://hub.docker.com/](https://hub.docker.com/)是免费的，在那里你可以创建一个码头工人标识，你可以在码头工人中心和其他码头工人服务中使用。您的码头工人标识是您如何向码头工人服务进行身份验证以访问码头工人中心。这是通过`docker login`命令完成的:
