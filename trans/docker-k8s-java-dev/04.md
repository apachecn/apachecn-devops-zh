...
过一会儿，Spring splash 日志将出现在控制台中，您的微服务将准备好接受`HTTP`请求。很快，在[第 5 章](05.html)、*用 Java 应用程序创建映像*中，我们的目标将是从 Docker 容器中看到同样的东西:
...
当然，在现实世界中，您可能希望包含一些更高级的功能，例如身份验证和安全性。在开发自己的服务时，让 Spring Initializr 可用可以大大提高速度。在[第 5 章](05.html)、*用 Java 应用程序创建映像*中，我们将把我们的书店服务打包成 Docker 映像，并使用 Docker Engine 运行它。