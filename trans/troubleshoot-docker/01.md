...
![OS containers](graphics/image_01_001.jpg)
...
![Application containers](graphics/image_01_002.jpg)
...
![Application containers](graphics/image_01_003.jpg)
...
![Application containers](graphics/image_01_004.jpg)
...
![Diving into Docker](graphics/image_01_005.jpg)
...
4.  If there are some changes made to the container while it is running, which are likely to be preserved, a container can be converted back to an image by using the `Docker commit` after the container has been stopped:
    ...
    ![Docker lifecycle](graphics/image_01_006.jpg)
...
![Unikernels](graphics/image_01_007.jpg)
