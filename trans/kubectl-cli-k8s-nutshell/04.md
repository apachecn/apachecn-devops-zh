...
![Figure 4.1 – Pod with two containers ](image/B16411_04_001.jpg)
...
![Figure 4.2 – Deployment with three pods ](image/B16411_04_002.jpg)
...
前面的命令用一个`nginx-86c57db685-c9s49`吊舱创建了一个`nginx`部署。
...
![Figure 4.3 – Kubernetes node ](image/B16411_04_003.jpg)
...
![Figure 4.4 – Kubernetes node ](image/B16411_04_004.jpg)
...
![Figure 4.5 – Exporting the nginx service ](image/B16411_04_005.jpg)
