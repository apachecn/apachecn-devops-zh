...
图 1.1–Kubernetes建筑的 10，000 英尺视图
...
*   Docker桌面:[https://www.docker.com/products/docker-desktop](https://www.docker.com/products/docker-desktop)

在这本书里，我们将使用谷歌云的 GKE Kubernetes集群。
...
*   `get`:显示一个或多个资源。例如，您可以获得运行Pod 的列表或Pod 的 YAML 输出。
*   `edit`:编辑资源—例如，编辑部署。
