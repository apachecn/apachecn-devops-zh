...
![Figure 11.1 – Secrets List output from kubectl](Images/B14790_11_001.jpg)
...
![Figure 11.2 – Helm Release List output](Images/B14790_11_002.jpg)
...
如您所见，Helm 允许应用程序的无缝模板化、发布、升级和回滚。正如我们之前提到的，Kustomize 击中了许多相同的点，但以一种非常不同的方式做到了这一点——让我们看看是如何做到的。
