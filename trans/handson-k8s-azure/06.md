...
4.  It will take a couple of minutes for the application gateway to deploy. Once it is created, you can see the resource in the Azure portal. To find this, look for **agic** (or the name you gave your application gateway) in the Azure search bar, and select your application gateway.
    ...
    ![Searching for Application Gateway using the Azure portal search bar](image/B17338_06_01.jpg)

    图 6.1:在 Azure 搜索栏中查找应用程序网关

5.  This will show you your application gateway in the Azure portal, as shown in *Figure 6.2*:

    ![An overview of the Application Gateway pane in the Azure portal](image/B17338_06_02.jpg)
...
![Browsing to the DNS name configured for the public IP address to verify if we can connect to the Application Gateway](image/B17338_06_03.jpg)
...
1.  To launch the guestbook application, type in the following command:
    ...
    ![Creating the guestbook application that we’ve used in the previous chapters](image/B17338_06_04.jpg)
...
3.  If you now go to http://dns-name/, which you created in the *Creating a new application gateway* section, you should get an output as shown in *Figure 6.5*:
    ...
    ![Accessing the guestbook application via the ingress](image/B17338_06_05.jpg)
    ...
    ![Flowchart displaying a publicly accessible ingress](image/B17338_06_06.jpg)
...
![Output confirming that the front-end service remains private to the cluster](image/B17338_06_07.jpg)
...
![Installing cert-manager on the cluster](image/B17338_06_08.jpg)
...
3.  First off, **cert-manager** created a **certificate** object for you. You can look at the status of that object using the following:
    ...
    ![Output displaying the status of the certificate object  with ready as false](image/B17338_06_09.jpg)
...
4.  As you can see, the certificate isn't ready yet. There is another object that **cert-manager** created to actually get the certificate. This object is **certificaterequest**. You can get its status by using the following command:
    ...
    ![Output displaying the status of the certificaterequest object as False](image/B17338_06_10.jpg)
    ...
    ![Output displaying additional details about the certificaterequest object  showing that cert-manager is waiting on certificate issuance](image/B17338_06_11.jpg)
...
5.  After a couple of additional seconds, the **describe** command should return a successful certificate creation message. Run the following command to get the updated status:
    ...
    ![Output displaying the successful certificate creation message](image/B17338_06_12.jpg)
...
![Using the Let's Encrypt staging server, the certificate isn't trusted by default](image/B17338_06_13.jpg)
...
![The web page displaying a valid certificate](image/B17338_06_14.jpg)
